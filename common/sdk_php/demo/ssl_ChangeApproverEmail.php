...
$changeApproverEmailParams = array(
    'orderId' => $orderId,
	'approverEmail' => 'test@onlinenic.com',//input new approveEmail
);
$cmd        = $api->buildCommand('ssl', 'ChangeApproverEmail', $changeApproverEmailParams);
$rs         = $api->request($cmd);
$lastResult = $api->getLastResult();
if ($rs) {
	$error = getError(__LINE__, $rs, $lastResult);
