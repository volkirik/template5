...
$params = array(
	...
	'domain'     => $domain,
	'password'   => 'dfd4fd45fd1',//Transfer code Setting by Losing Reseller
	'curID'      => 147104,//The current account ID of domain.
);
$cmd        = $api->buildCommand('domain', 'RequestCustTransfer', $params);
$rs         = $api->request($cmd);
$lastResult = $api->getLastResult();
if ($rs) {
	$error = getError(__LINE__, $rs, $lastResult);
