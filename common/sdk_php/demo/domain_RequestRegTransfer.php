...
$params = array(
	...
	'domain'     => $domain,
	'mailway'    => 'Off',//Choose the way to deliever the transfer confiramation. Default is Off;  On ¨C On behalf of reseller  Off - On behalf of OnlineNIC
);
$cmd        = $api->buildCommand('domain', 'RequestRegTransfer', $params);
$rs         = $api->request($cmd);
$lastResult = $api->getLastResult();
if ($rs) {
	$error = getError(__LINE__, $rs, $lastResult);
