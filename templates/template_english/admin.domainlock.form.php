<?php
	...
	$smarty->assign ('content_title', 'Secure Your Domains');
    $smarty->assign ('content_tip', '&nbsp; Domain locking prevents unwanted registrar 
	                    transfers and DNS changes to the domain names');
