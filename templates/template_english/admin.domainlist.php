<?php
    ...
    $smarty->assign ('content_tip', 'Welcome to Manage Domain Area!
	    You may adopt this tool to implement domain management,
	  including domain renewal & deletion, domain information modification
	    and nameserver change.');
