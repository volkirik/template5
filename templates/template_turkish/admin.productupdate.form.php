<?php
	...
	$smarty->assign ('content_title', 'Alanadı Türü Ekle');
	$smarty->assign ('content_tip', 'Lütfen yeni alanadı türü eklemek için SQL sorgularını giriniz
	                    (Örnek sorgular aşağıda gösterilmiştir)');
