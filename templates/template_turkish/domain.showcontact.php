...
$smarty->assign ('content_title', 'Alan Adı İletişim Bilgilerini Düzenle');
$smarty->assign ('content_tip', 'Eski bilgilerin yerine geçecek yeni iletişim bilgilerini doğrudan girin.');
	...
	$smarty->assign ('content_body', CURRENT_THEME.'/domain.showcontact.tpl');
