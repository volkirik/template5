<?php
	...
	$smarty->assign ('content_title', 'Alan Adı Listesi');
    $smarty->assign ('content_tip', 'Alan Adı Yönetim Alanına Hoş Geldiniz!
	    Bu aracı alan adı yönetimini uygulamak için kullanabilirsiniz,
	  alan adı yenileme ve silme, alan adı bilgisi değiştirme
	    ve ad sunucusu değişikliği dahil.');
