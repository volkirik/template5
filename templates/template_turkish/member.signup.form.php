...
$smarty->assign ('content_title', 'Kayıt Ol');
$smarty->assign ('content_tip', 'Üyemiz olma yolunda hoş geldiniz! 
    Yıldız (*) ile işaretlenmiş alanların tamamını doldurmalısınız.');
