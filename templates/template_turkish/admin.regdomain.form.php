<?php
	...
	$smarty->assign ('content_title', 'Alan Adı Kaydet');
    $smarty->assign ('content_tip', "Lütfen doğru kayıt bilgilerini
    aşağıdaki forma girin.");
    ...
    //echo "PRODUCT_PRICE  ". print_r($product_price); echo "end $product_price[1]";
	...
	$smarty->assign ('b_address1', $b_address1);
	$smarty->assign ('b_address2', $b_address2);
	...
	//$smarty->assign ('domain', $domain.$product_info[3]);
	...
	$smarty->assign ('content_body', CURRENT_THEME.'/admin.regdomain.form.tpl');
