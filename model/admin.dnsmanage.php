...
//		print_r($_REQUEST)		;
        ...
        $sql = "select * from dns where member_id like '".$member_id."' and dns like '".$dns."'";
		$rs = $conn->Execute($sql);
		if(!$rs)
		{
...
*/
	...
	//	echo '<br>Reg DNS result <br><textarea style="height: 300px; width: 500 px; border: none; ">'.$regresult.'</textarea><br><br>';
    ...
    */	
	    ...
	    if(!strstr($regresult, "<result code=\"1000\">")){
		    ...
		    $sql = "insert into dns (member_id, dns, ip, regtime) values (".
			        $_SESSION["sessionID"]." , '".$dns."' , '".$ipaddr."', now())";    
			$conn->Execute ($sql);
