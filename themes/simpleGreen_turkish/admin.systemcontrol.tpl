...
{/if}
    ...
    <tr> 
      <td width="32%" height="25" bgcolor="#E1ECFB">Bayi ID</td>
      <td width="68%" height="25" bgcolor="#F2F8FD">
    ...
    <tr> 
      <td width="32%" height="25" bgcolor="#E1ECFB">Sunucu Hostu</td>
      <td width="68%" height="25" bgcolor="#F2F8FD">
  ...
  <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr> 
      <td colspan="2">Not: "Sunucu Hostu" satırında, şablonu gerçek zamanlı bir ortamda çalıştırmak istiyorsanız, "www.onlinenic.com" adresini girin. Şablonu önce test etmek istiyorsanız, "218.5.65.6" adresini girin.</td>
    </tr>
  </table>
  <br>
