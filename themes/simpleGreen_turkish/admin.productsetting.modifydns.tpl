    ...
    <tr> 
      <td width="25%" height="25" colspan="2"> 
        <table width="100%" border="0" cellspacing="1" cellpadding="2" class="border1">
          <tr> 
            <td height="20" width="30%" bgcolor="#E1ECFB"><b>Ürün ID'si</b></td>
...
{/if}
    ...
    <tr> 
      ...
      <td width="40%" height="25"> 
        ...
        <input type="submit" name="Submit" value="Varsayılan DNS'i Düzenle" >
        <input type="button" name="back" value="Geri" onClick="goBack(this.form);">
      </td>
    </tr>
  </table>
</form>
