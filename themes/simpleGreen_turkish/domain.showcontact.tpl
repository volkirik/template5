  ...
  <tr> 
    ...
    <input type="hidden" name="registrant" value="{$registrant}">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="25%">Alan adı şifresi:</td>
            <td width="25%"> 
...
<!--                <input type="text" name="registrant" value="{$registrant }" readonly>
        ...
        <center>
            <input type=button name="copy_r2a" value="Kayıt Eden Bilgilerini Yöneticiye Kopyala"
                 onClick="regToAdmin();">
        </center>   
        <hr size="1" noshade>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <b>Teknik Bilgiler</b><br>
        <center>
            <input type=button name="copy_r2t" value="Kayıt Eden Bilgilerini Teknik Bilgiler ile Kopyala"
                 onClick="regToTech();">
        </center>   
        <hr size="1" noshade>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <b>Fatura Bilgileri</b><br>
        <center>
            <input type=button name="copy_r2b" value="Kayıt Eden Bilgilerini Fatura Bilgilerine Kopyala"
