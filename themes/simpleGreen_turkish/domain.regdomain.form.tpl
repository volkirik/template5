...
{php}
	for($i = 1; $i < 11; $i ++)
	{
		if(($product_info[3] == ".us" || $product_info[3] == ".info" || $product_info[3] == ".biz") && ($i == 1))
		{
			...
			if($i == $year)
			{
				echo "<option value=\"" . $i . "\" selected>$" . $product_price[$i] . "/" . $i . (($i == 1)?"yıl":"yıl") . "</option>";
			}else {
				echo "<option value=\"" . $i . "\">$" . $product_price[$i] . "/" . $i . (($i == 1)?"yıl":"yıl") . "</option>";
			}
		}
	}
{/php}
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="39%">Alan adı sahibi tam adı</td>
            <td width="61%"> 
          ...
          <tr> 
            <td width="39%">Telefon (örnek:+1.4156656387)</td>
            <td width="61%"> 
              <input type="text" name="r_telephone" value="{$r_telephone }">
              <font color="#990000">*</font></td>
          </tr>
          <tr> 
            <td width="39%">Faks (örnek:+1.4156657168)</td>
            <td width="61%"> 
        ...
        <center>
            <input type=button name="copy_r2a" value="Alan Adı Sahibi Bilgilerini Yöneticiye Kopyala"
                 onClick="regToAdmin();">
        </center>  
        <hr size="1" noshade>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <center>
            <input type=button name="copy_r2a" value="Alan Adı Sahibi Bilgilerini Teknik İletişim Bilgilerine Kopyala"
                 onClick="regToTech();">
        </center> 
        <hr size="1" noshade>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="39%">Teknik iletişim tam adı</td>
            <td width="61%"> 
        ...
        <br><br>
        <b>Faturalama İletişim Bilgileri</b><br>
        <center>
            <input type=button name="copy_r2a" value="Alan Adı Sahibi Bilgilerini Faturalama İletişim Bilgilerine Kopyala"
                 onClick="regToBilling();">
        </center> 
        <hr size="1" noshade>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="39%">Faturalama iletişim tam adı</td>
            <td width="61%"> 
...
{if $product_info[3] == ".us"}
			...
			<br>
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
                <tr>
                  <td colspan="3">Bu gereklilik, yalnızca Amerika Birleşik Devletleri ile yasal bağlantısı olan kişilerin 
                    veya kuruluşların usTLD alan adlarına kayıt yaptırmalarına izin verilmesini sağlamayı amaçlamaktadır.</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="28%" valign="top"> 
                    ...
                    Kategori 1: (1)</td>
                  <td width="59%">Bir ABD vatandaşı olan gerçek kişi</td>
                </tr>
                <tr>
                  <td width="13%"></td>
                  <td valign="top" width="28%"> 
                    ...
                    Kategori 1: (2)</td>
                  <td width="59%">ABD veya herhangi bir mülkünde 
                    veya bölgesinde daimi ikamet eden bir gerçek kişi</td>
                </tr>
                <tr>
                  <td width="13%"></td>
                  <td valign="top" width="28%"> 
                    ...
                    Kategori 2: (1)</td>
                  <td width="59%">ABD'nin 50 eyaletinden birinde, Columbia Bölgesi'nde veya ABD'nin herhangi bir mülkünde veya bölgesinde kurulan 
veya ABD eyaletlerinden birinin yasalarına göre örgütlenmiş veya başka bir şekilde oluşturulmuş bir ABD kuruluşu, Columbia Bölgesi 
veya herhangi bir mülkü veya bölgesi ya da bir ABD federal, eyalet veya yerel hükümet 
                    kurumu veya bunun bir alt birimi</td>
                </tr>
                <tr>
                  <td width="13%"></td>
                  <td valign="top" width="28%"> 
                    ...
                    Kategori 3: (1)</td>
                  <td width="59%">Amerika Birleşik Devletleri'nde veya herhangi bir mülkünde 
                    veya bölgesinde meşru bir varlığı olan bir kuruluş veya kuruluş: Düzenli olarak yasal faaliyetlerde bulunan 
                    (mal veya hizmetlerin satışı veya diğer ticari, ticari 
                    veya ticari olmayan, kâr amacı gütmeyen ilişkiler dahil olmak üzere Amerika Birleşik Devletleri'nde)</td>
                </tr>
                <tr>
                  <td width="13%"></td>
                  <td valign="top" width="28%"> 
                    ...
                    Kategori 3: (2)</td>
                  <td width="59%">Amerika Birleşik Devletleri'nde veya herhangi bir mülkünde 
                    veya bölgesinde meşru bir varlığı olan bir kuruluş veya kuruluş: ABD'de bir ofisi veya başka bir tesisi bulunan</td>
                </tr>
                <tr>
                  <td width="13%">&nbsp;</td>
                </tr>
                <tr>
                  <td width="13%"></td>
                  <td valign="top" width="28%">Kategori 3 İçin Anavatan</td>
                  <td width="59%"> 
                    <select name="validator">
                      ...
                      <option value="IO">BRİTANYA HİNT OKYANUSU</option>
                      <option value="BN">BRUNEİ DARUSSALAM</option>
                      ...
                      <option value="CY">GÜNEY KIBRIS RUM KESİMİ</option>
                      ...
                      <option value="GI">CİBRALTAR</option>
                      ...
                      <option value="HM">HEARD ADASI VE MC</option>
                      <option value="VA">VATİKAN ŞEHRİ (VATİKAN C</option>
                      ...
                      <option value="KP">KORE DEMOKRATİK HALK CUM</option>
                      <option value="KR">KORE CUMHURİYETİ</option>
                      <option value="KW">KUVEYT</option>
                      <option value="KG">KIRGIZİSTAN</option>
                      <option value="LA">LAOS HALK CUMHURİYETİ</option>
                      <option value="LV">LETONYA</option>
                      <option value="LB">LÜBNAN</option>
                      <option value="LS">LESOTO</option>
                      <option value="LR">LİBERYA</option>
                      <option value="LY">LİBYA ARAP CUM</option>
                      ...
                      <option value="FM">MİKRONEZYA, FEDERAT</option>
                      <option value="MD">MOLDOVA CUM</option>
                      ...
                      <option value="MP">KUZEY MARIANA AD</option>
                      ...
                      <option value="RE">RUNİON</option>
                      <option value="RO">ROMANYA</option>
                      <option value="RU">RUSYA FEDERASYONU</option>
                      <option value="RW">RUANDA</option>
                      <option value="SH">AZİZ HELENA</option>
                      <option value="KN">AZİZ KİTTLER VE NEV</option>
                      <option value="LC">AZİZ LUCIA</option>
                      <option value="PM">AZİZ PİERRE VE MI</option>
                      <option value="VC">AZİZ VİNCENT VE T</option>
                      <option value="WS">SAMOA</option>
                      <option value="SM">SAN MARİNO</option>
                      <option value="ST">SAO TOME VE PRİNCİ</option>
                      ...
                      <option value="GS">GÜNEY GEORGİA VE T</option>
                      <option value="ES">İSPANYA</option>
                      <option value="LK">SRI LANKA</option>
                      <option value="SD">SUDAN</option>
                      <option value="SR">SURİNAM</option>
                      <option value="SJ">SVALBARD VE JAN MA</option>
                      <option value="SZ">SVAZİLAND</option>
                      <option value="SE">İSVEÇ</option>
                      <option value="CH">İSVİÇRE</option>
                      <option value="SY">SURİYE ARAP CUM</option>
                      <option value="TW">ÇİN TAİBEİ</option>
                      <option value="TJ">Tacikistan</option>
                      <option value="TZ">TANZANYA BİRLEŞİK CUM</option>
                      ...
                      <option value="TC">TURKS VE CAICOS IS</option>
                      ...
                      <option value="UM">ABD MINOR</option>
                      <option value="UY">URUGUAY</option>
                      <option value="UZ">ÖZBEKİSTAN</option>
                      <option value="VU">VANUATU</option>
                      <option value="VE">VENEZUELA</option>
                      <option value="VN">VİETNAM</option>
                      <option value="VG">BRİTANYA BİRLEŞİK DEVLETLERİ</option>
                      <option value="VI">ABD BİRLEŞİK DEVLETLERİ</option>
                ...
                <tr>
                  ...
                  <td colspan="2"> 
                    ...
                    Kâr amaçlı iş kullanımı<br>
                    <input type="radio" name="apppurpose" value="P2">
                    Kâr amacı gütmeyen iş, kulüp, dernek, dini kuruluş, 
                    vb.<br>
...
{/if}
          ...
          <tr> 
            <td width="39%">&nbsp;</td>
            <td width="61%"> 
              <input type="submit" name="Submit" value="Alan adı kaydı">
            </td>
          </tr>
        </table>
        <br>
