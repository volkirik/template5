...
function doDelete()
{$smarty.ldelim}
	if(confirm("Bu üyenin silindiğinden emin misiniz?"))
	{$smarty.ldelim}
		return true;
	{$smarty.rdelim}
	else
...
<form action="{$php_self}" method="post" style="margin:0px">
    ...
    <tr>
      <td> 
        <table width="100%" border="0" cellspacing="5" cellpadding="0" align="center">
          <tr> 
            <td align=center> Kaydolma tarihi aralığı 
 ...
 {if $orders == 1 }
                ...
                <option value="2">Alfabetik Sıralama</option>
                <option value="3">Kaydolma Tarihi</option>
{elseif $orders == 2}
                <option value="1">Üye Seviyesi</option>
                <option value="2" selected>Alfabetik Sıralama</option>
                <option value="3">Kaydolma Tarihi</option>
{elseif $orders == 3}
                <option value="1">Üye Seviyesi</option>
                <option value="2">Alfabetik Sıralama</option>
                <option value="3" selected>Kaydolma Tarihi</option>
{else}
                <option value="1" selected>Üye Seviyesi</option>
                <option value="2">Alfabetik Sıralama</option>
                <option value="3">Kaydolma Tarihi</option>
