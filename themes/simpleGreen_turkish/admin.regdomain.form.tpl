...
for($i = 1; $i < 11; $i ++)
{
	if(($product_info[3] == ".us" || $product_info[3] == ".info" || $product_info[3] == ".biz") && ($i == 1))
	{
		...
		if($i == $year)
		{
			echo "<option value=\"" . $i . "\" selected>$" . $product_price[$i] . "/" . $i . (($i == 1)?"yıl":"yıllar") . "</option>";
		}else {
			echo "<option value=\"" . $i . "\">$" . $product_price[$i] . "/" . $i . (($i == 1)?"yıl":"yıllar") . "</option>";
		}
	}
}*/
{/php}
   ...
   --> <input type=hidden name=year value="{$year}"></td>
          ...
          <tr> 
            <td width="25%">Domain için şifre:</td>
            <td width="28%"> 
              <input type="password" name="password1" value="{$password1}">&nbsp;(6-12 karakter)
            </td>
        ...
        <b><br><br>
        Teknik İrtibat Bilgileri</b><br>
       <center>
            <input type=button name="copy_r2a" value="Kayıt Eden Bilgilerinden Kopyala"
                 onClick="regToTech();">
        </center> 
        <hr size="1" noshade>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="39%">Teknik İrtibat Tam Adı</td>
            <td width="61%"> 
        ...
        <br><br>
        <b>Faturalandırma İrtibat Bilgileri</b><br>
         <center>
            <input type=button name="copy_r2a" value="Kayıt Eden Bilgilerinden Kopyala"
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="39%">Faturalandırma İrtibat Tam Adı</td>
            <td width="61%"> 
...
{ if $product_info[3] == ".us"}
			...
			<br>
              <b>NEXUS Bilgisi</b><br>
              <hr size="1" noshade>
              <table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
                <tr>
                  <td colspan="3">Bu gereklilik, yalnızca Amerika Birleşik Devletleri'ne yasal olarak önemli bir bağlantısı olan bireylerin veya kuruluşların usTLD alan adlarına kaydolmasına izin verildiğini sağlamak amacıyla getirilmiştir.</td>
                </tr>
                <tr>
                  <td colspan="3">Lütfen uygun statünüzü seçin</td>
                </tr>
                <tr>
                  ...
                  <td width="28%" valign="top"> 
                    ...
                    Kategori 1: (1)</td>
                  <td width="59%">Bir ABD vatandaşı olan doğal kişi</td>
                </tr>
                <tr>
                  <td width="13%"></td>
                  <td valign="top" width="28%"> 
                    ...
                    Kategori 1: (2)</td>
                  <td width="59%">Amerika Birleşik Devletleri veya herhangi bir mülkünün daimi sakini olan doğal kişi</td>
                </tr>
                <tr>
                  <td width="13%"></td>
                  <td valign="top" width="28%"> 
                    ...
                    Kategori 2: (1)</td>
                  <td width="59%">ABD eyaletlerinden birinde, Columbia Bölgesi'nde veya ABD'nin herhangi bir mülkünde kurulmuş bir ABD kuruluşu veya ABD eyaletlerinden birinin yasaları uyarınca kurulmuş veya başka bir şekilde organize edilmiş bir kuruluş veya bir ABD federal, eyalet veya yerel yönetim birimi veya onun siyasi alt birimi</td>
                </tr>
                <tr>
                  <td width="13%"></td>
                  <td valign="top" width="28%"> 
                    ...
                    Kategori 3: (1)</td>
                  <td width="59%">Amerika Birleşik Devletleri'nde veya herhangi bir mülkünde iyi niyetli varlığı olan bir kuruluş: Amerika Birleşik Devletleri'nde düzenli olarak yasal faaliyetler (mal veya hizmet satışı veya diğer ticari, ticari olmayan veya kar amacı gütmeyen ilişkiler) gerçekleştiren bir kuruluş</td>
                </tr>
                <tr>
                  <td width="13%"></td>
                  <td valign="top" width="28%"> 
                    ...
                    Kategori 3: (2)</td>
                  <td width="59%">Amerika Birleşik Devletleri'nde veya herhangi bir mülkünde iyi niyetli varlığı olan bir kuruluş: Amerika Birleşik Devletleri'nde bir ofisi veya diğer bir tesisi bulunan bir kuruluş</td>
                </tr>
                <tr>
                  <td width="13%">&nbsp;</td>
                </tr>
...
<tr>
  <td valign="top" width="13%">Domainin Amacı</td>
  <td colspan="2"> 
    <input type="radio" name="apppurpose" value="P1" checked> 
    Kar amaçlı ticari kullanım<br>
    ...
    Eğitim amaçlı kullanım<br>
    <input type="radio" name="apppurpose" value="P5"> 
    Hükümet amaçlı kullanım<br>
  </td>
</tr>
</table>
{/if}
...
<tr> 
  <td width="39%">&nbsp;</td>
  <td width="61%"> 
    <input type="submit" name="Submit" value="Domaini kaydet">
  </td>
</tr>
</table>
<br>
