  ...
  <tr>
    <td> <b><br>
      ...
      <table width="50%" border="0" cellspacing="1" cellpadding="2" class="border1" align="center">
        ...
        <tr> 
          <td height="20" width="30%" bgcolor="#E1ECFB"><b>Bakiyeniz</b></td>
          ...
          <tr> 
            ...
            <td width="9%"> 
              <select name="transation">
                {if $transation == "1,2"}
                  <option value="1,2" selected>Hepsi</option>
                  <option value="1">Yatırma</option>
                  <option value="2">Ödeme</option>
                {elseif $transation == "1"}
                  <option value="1,2">Hepsi</option>
                  <option value="1" selected>Yatırma</option>
                  <option value="2">Ödeme</option>
                {else}
                  <option value="1,2">Hepsi</option>
                  <option value="1">Yatırma</option>
      ...
      <form style="margin:0px">
        <table width="95%" class="border1" cellspacing="1" cellpadding="0" align="center">
          <tr class="fieldName"> 
            ...
            <td width="14%" height="20"><b><font color="#FFFFFF">&nbsp;Miktar</font></b></td>
            <td width="22%" height="20"><b><font color="#FFFFFF">&nbsp;Mod</font></b></td>
