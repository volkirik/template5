      ...
      <form method="post" action="{$php_self}" name="domainManage" style="margin:0px">
        <table width="100%" border="0" cellspacing="1" cellpadding="1" align="center">
          <tr class="fieldName"> 
            ...
            <td width="27%" height="20"><b><font color="#FFFFFF">Alan Adı(Kullanıcı Adı)</font></b></td>
            <td width="15%" height="20"><b><font color="#FFFFFF">Dns1</font></b></td>
            <td width="17%" height="20"><b><font color="#FFFFFF">Dns2</font></b></td>
            <td width="25%" height="20"><b><font color="#FFFFFF">Kayıt Tarihi</font></b></td>
