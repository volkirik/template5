<form action="{$content_action}" method="post">
  <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      <td width="25%" height="25" colspan="2"><font color="#FF0000" class="p8">Yıldız* zorunlu alanı belirtir</font></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td width="25%" height="25">Telefon (ör: +1.4156657168)</td>
      <td width="75%" height="25"> 
    ...
    <tr> 
      <td width="25%" height="25">Faks (ör: +1.4156657168)</td>
      <td width="75%" height="25"> 
