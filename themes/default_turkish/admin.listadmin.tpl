      ...
      <form style="margin:0px">
        <table width="100%" border="0" cellspacing="1" cellpadding="0" align="center">
          <tr class="fieldName"> 
            ...
            <td height="20"><b><font color="#FFFFFF">&nbsp;İsim</font></b></td>
            <td height="20"><b><font color="#FFFFFF">&nbsp;Bölüm</font></b></td>
    ...
    {section name=name loop=$rs}		
		...
		{/if}
          ...
          <td height="20" class="p8"{$color}>
            ...
            <a href="{$php_self}?action=showSetTask&currentPage={$currentPage}&admin_id={$rs[name][0][0]}"><img src="{$RELA_DIR}templates/{$CURRENT_SKIN}/images/lock.gif" border="0" alt="Erişim ayarları"></a>
          </td>
        </tr>
    {/section}
		<tr> 
