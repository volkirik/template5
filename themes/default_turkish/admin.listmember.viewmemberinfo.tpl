...
{/if}
    ...
    <tr> 
      <td colspan="2" height="25"><b><br>
        <br>
        Kayıt Sahibi Bilgileri</b></td>
    </tr>
    <tr> 
      <td colspan="2" height="25"> 
        <table width="100%" border="0" cellspacing="1" cellpadding="2" class="border1">
          <tr> 
            <td width="30%" height="20" bgcolor="#EFEFEF">Kayıt Sahibi</td>
            <td width="70%" height="20"> 
             {$r_name}
            </td>
          </tr>
          <tr> 
            <td width="30%" height="20" bgcolor="#EFEFEF">Organizasyon</td>
            <td width="70%" height="20"> 
              {$r_org}
            </td>
          </tr>
    ...
    <tr> 
      ...
      <td width="70%" height="25"> 
        <input type="submit" name="Submit" value="Geri Dön">
