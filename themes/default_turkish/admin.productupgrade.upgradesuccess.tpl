...
<form action="{$php_self}" method="post">
  <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr> 
      <td colspan="2" height="25"><b>Alan adı yükseltme başarılı, </b>lütfen alan adı fiyatını, DNS vb. ayarlamak için &quot;Ürün ayarı&quot;na tıklayın ve ardından alan adı işlemini başlatın<br>
        <br>
