...
{$smarty.ldelim}
	...
	{$smarty.ldelim}
		...
		{$smarty.ldelim}
		 ...
		 {$smarty.rdelim}
	 {$smarty.ldelim} else {$smarty.ldelim}
		for(i = 2; i < 11; i ++)
		{$smarty.ldelim}
...
{/if}
    ...
    <tr> 
      <td colspan="2" height="25"><b>Kayıt fiyatları</b></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td colspan="2" height="25"><b>Yenileme fiyatları</b></td>
    </tr>
    <tr> 
      <td colspan="2" height="25"> 
        <table width="100%" border="0" cellspacing="1" cellpadding="0" class="border1">
    ...
    <tr> 
      <td colspan="2" height="25"><b>Alan Adı Eşitleme ücreti</b></td>
    </tr>
    <tr> 
      <td colspan="2" height="25"> 
        <table width="100%" class=border1 cellspacing="1" cellpadding="0">
    ...
    <tr> 
      <td  height="25" align="center" colspan=2> 
        <input type="submit" name="Submit" value="Fiyatı Değiştir">
