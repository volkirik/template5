...
<table width="100%"  cellspacing="1" cellpadding="2" align="center" class=border1 style=" border-width: 1px; padding: 1px">
	...
	<tr><td> &nbsp; </td></tr>
    <tr>   
        <td bgcolor="#F2F8FD" align="center"><input type="text" name="sql_products" style="width: 550px;"> </td>
    </tr>
	<tr> 
	...
	<tr>   
        <td bgcolor="#F2F8FD" align="center"> <input type="text" name="sql_ordermode1" style="width: 550px;"> </td>
    </tr>
	<tr> 
	...
	<tr>   
        <td bgcolor="#F2F8FD" align="center"> <input type="text" name="sql_ordermode2" style="width: 550px;"> </td>
    </tr>
	<tr>
	...
	<tr>   
        <td bgcolor="#F2F8FD" align="center"> <input type="text" name="sql_ordermode3" style="width: 550px;"> </td>
    </tr>
	<tr>
	...
	<tr>   
        <td bgcolor="#F2F8FD" align="center"> <input type="text" name="sql_ordermode4" style="width: 550px;"> </td>
    </tr>
	<tr>
	...
	<tr>   
        <td bgcolor="#F2F8FD" align="center"> <input type="text" name="sql_ordermode5" style="width: 550px;"> </td>
    </tr>
	<tr>
