      ...
      <table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td valign="top" align="center"> 
            ...
            <p>&nbsp;</p>
            <p><font color="#0B79B5"><b>The Template 4.0 has been Installed successfully</b></font></p>
            <p>&nbsp;</p>
            <table width="50%" border="0" cellspacing="1" cellpadding="2" bgcolor="#000000">
              <tr> 
                ...
                <td height="22" bgcolor="#DBD9C7" width="48%">100</td>
              </tr>
              <tr> 
                <td height="22" bgcolor="#FFCC00" align="center" width="52%">Super-Administrator Password </td>
                <td height="22" bgcolor="#DBD9C7" width="48%"><?php echo $admin_password1 ?></td>
              </tr>
            </table>
            <p>&nbsp;</p>
            <p><a href="../member/myaccount.php">Click here  to login admin page</a></p>
            <p>&nbsp;</p>
	      </td>
        </tr>
      </table>
